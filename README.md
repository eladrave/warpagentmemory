...
- **Local / GCS Storage:** Keeps your memories organized by day (`memory_YYYY-MM-DD.md`) and a synthesized `generic_memory.md` on a mounted GCS volume, bypassing strict Google Drive SA quotas.
